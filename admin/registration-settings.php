...
use TimelineWidgetAddonForElementorPro\TWAI_Settings_API as TWAI_Settings_API;
	...
	class cool_plugins_timeline_registration_Settings {
		...
		public function add_registration_page() {
			if ( $this->settings == null ) {
				$this->settings = new TWAI_Settings_API();
			}
		...
		public function admin_menu() {
			add_submenu_page( 'cool-plugins-timeline-addon', 'Cool Plugins Product Registration', 'License', 'manage_options', 'timeline-addons-license', array( $this, 'show_Page' ), 2 );
		}
